...
- This is hello-rails-back-end application <a href="https://github.com/DianaBeki/rails-back-end">back-end Link</a>
...
```sh
  cd my-folder
  git clone git@github.com:DianaBeki/react-front-end.git
```
